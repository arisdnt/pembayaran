              ...
              <div className="border-2 border-slate-300 bg-slate-50 p-4">
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="bg-slate-100 border border-slate-300 p-3 text-center">
                    <Text size="1" className="text-slate-600 uppercase tracking-wider text-[0.65rem] block mb-1">
                      Maksimal
                    </Text>
                  ...
                  <div className="bg-blue-50 border border-blue-300 p-3 text-center">
                    <Text size="1" className="text-blue-600 uppercase tracking-wider text-[0.65rem] block mb-1">
                      Terisi
                    </Text>
                  ...
                  <div className="bg-green-50 border border-green-300 p-3 text-center">
                    <Text size="1" className="text-green-600 uppercase tracking-wider text-[0.65rem] block mb-1">
                      Tersedia
                    </Text>
