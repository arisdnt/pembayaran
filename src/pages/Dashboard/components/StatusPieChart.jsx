...
export const StatusPieChart = memo(function StatusPieChart({ data, loading }) {
  // Tetap tampilkan chart meski sedang refresh
            ...
            return (
              <div key={item.name || index} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Text size="2" weight="bold" className="text-slate-900 font-mono transition-all duration-300">
