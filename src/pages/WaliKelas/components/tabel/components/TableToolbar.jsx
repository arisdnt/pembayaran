...
import { Plus, X, ListFilter, CheckCircle, CircleSlash } from 'lucide-react'
...
export function TableToolbar({
  ...
  return (
    <div className="border-b border-slate-300 bg-gradient-to-b from-slate-50 to-slate-100">
      {/* Grid 10 kolom identical pattern */}
      <div
      ...
      >
        ...
        <div style={{ gridColumn: 'span 1' }} className="min-w-0 overflow-hidden">
          <Select.Root value={filterStatus} onValueChange={onFilterChange}>
            <Select.Trigger
              style={{
                borderRadius: 0,
                border: '1px solid #cbd5e1',
        ...
        {/* Kolom 3: Reset (sebelah dropdown) */}
        <div style={{ gridColumn: 'span 1' }} className="min-w-0 overflow-hidden">
          <Button
