...
import { WaliKelasTable } from '../components/tabel/WaliKelasTable'
import WaliKelasFormDialog from '../components/form/WaliKelasFormDialog'
...
function WaliKelasContent() {
  ...
  const handleOpenEdit = (item) => {
    setEditMode(true)
    // Create a new object to trigger useEffect in form
    setCurrentItem({
      id: item.id,
