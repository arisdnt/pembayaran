import { RiwayatDetailInfo } from './components/RiwayatDetailInfo'
import { RiwayatTagihanSection } from './components/RiwayatTagihanSection'
  ...
  return (
    <div className="relative flex h-full flex-col border border-slate-300 bg-white shadow-lg">
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        {/* Tagihan Section */}
        <RiwayatTagihanSection riwayatId={selectedItem.id} />
      </div>
    </div>
  )
}
